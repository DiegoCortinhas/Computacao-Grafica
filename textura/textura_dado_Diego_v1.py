...
#    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP)
    ...
    reader = png.Reader(filename='lado2.png')
    w, h, pixels, metadata = reader.read_flat()
    if(metadata['alpha']):
        modo = GL_RGBA
    else:
...
#    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP)
   ...
   ################################################################################
    ...
    reader = png.Reader(filename='lado3.png')
    w, h, pixels, metadata = reader.read_flat()
    if(metadata['alpha']):
        modo = GL_RGBA
    else:
...
#    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP)
   ...
   ################################################################################
    ...
    reader = png.Reader(filename='lado4.png')
    w, h, pixels, metadata = reader.read_flat()
    if(metadata['alpha']):
        modo = GL_RGBA
    else:
...
#    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP)
    ...
    reader = png.Reader(filename='lado5.png')
    w, h, pixels, metadata = reader.read_flat()
    if (metadata['alpha']):
        modo = GL_RGBA
    else:
    ...
    reader = png.Reader(filename='lado6.png')
    w, h, pixels, metadata = reader.read_flat()
    if (metadata['alpha']):
        modo = GL_RGBA
    else:
